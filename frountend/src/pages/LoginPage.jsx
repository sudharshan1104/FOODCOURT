...
import Front from '../images/FB.png'
...
class LoginPage extends React.Component{
    ...
    click=()=>{
        if(this.state.username === 'jeyan' && this.state.password === 'jeyan123'){
            this.props.history.push(`/hotels`);
        }
        else if(this.state.username === 'admin' && this.state.password === 'admin123'){
    ...
    render(){
        return(
            ...
            <div id = "container">
            <div id="id1">
                <img src={Front} height="300" width="350" alt="Banner"/>
            </div>

            <div id="id2">
                <center><h1 id="logoApp">FOOD COURT</h1></center>
                    <div id="id3">
